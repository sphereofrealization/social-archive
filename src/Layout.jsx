        ...
        <Sidebar className="border-r border-gray-200">
          <SidebarHeader className="border-b border-gray-200 p-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="font-bold text-gray-900">Social Archive</h2>
                <p className="text-xs text-gray-500">Backup & Organize</p>
              </div>
            </div>
          </SidebarHeader>
        ...
        <main className="flex-1 flex flex-col">
          <header className="bg-white/80 backdrop-blur-sm border-b border-gray-200 px-6 py-4 md:hidden sticky top-0 z-10">
            <div className="flex items-center gap-4">
              ...
              <h1 className="text-xl font-semibold">Social Archive</h1>
            </div>
          </header>
